...
<main>
  ...
  <div class="checkout">
    <div class="checkout__header">
      <h1>Заказ</h1>
      <p>
      Оформите свой заказ легко и безопасно на этой странице.
      </p>
    </div>
    <div class="checkout__body">
      ...
      <form action="./checkout.php" method="post" class="checkout__method">
        <div class="checkout__method-group">
          <h2 class="checkout__method-title">Способ оплаты <span class="text-danger">*</span></h2>
        ...
        <?php endif; ?>
        <!-- TOMBOL PESAN (SUBMIT) -->
        <button type="submit" name="submit" class="checkout__button">Оплатить</button>
      </form>
      <!-- end payment methods -->
    </div>
  </div>
