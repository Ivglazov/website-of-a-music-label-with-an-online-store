...
<div class="admin">
  <div class="admin__header">
    <h1 class="admin__title">Транзакция окупилась</h1>
  </div>
  <div class="admin__body">
    ...
    <form action="./paid-transactions.php" method="get" class="admin__filters">
      ...
      <a href="./paid-transactions.php" class="admin__button">Сброс</a>
    </form>
        ...
        for ($rait = 0; $rait <= $drop; $rait++) { //$don = kolom tabel, $rait = baris tabel
          for ($don = 0; $don <= 5; $don++) {
            if ($rait == 0) { //header tabel
              if ($don == 0) {
                echo "<thead><tr><th>Количество транзакций</th>";
              } else if ($don == 1) {
