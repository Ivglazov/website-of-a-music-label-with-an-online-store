...
<div class="admin">
  <div class="admin__header">
    ...
    <h1 class="admin__title">Подробная информация о категории</h1>
  </div>
    ...
    <div class="admin__card">
      <form action="./category-single.php?category_id=<?= $category['category_id'] ?>" method="post" class="page-single">
        ...
        <div class="page-single__actions-container">
          <a href="./category-delete.php?category_id=<?= $category['category_id'] ?>" class="page-single__button">Удалить</a>
