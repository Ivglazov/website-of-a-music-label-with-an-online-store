...
<div class="admin">
  <div class="admin__header">
    <div class="admin__back">
      ...
      <a href="./unpaid-transactions.php">Назад</a>
    </div>
    <h1 class="admin__title">Данные по транзакции не были оплачены</h1>
    <div class="admin__actions">
      <?php if ($date_bank["order_status"] == "unpaid") : ?>
        <a href="./unpaid-transaction-approved.php?order_id=<?= $date_bank["order_id"] ?>" class="admin__button">Отметить как оплаченный</a>
      <?php else : ?>
  ...
  <div class="admin__body">
    <div class="admin__card">
      <p>Дата транзакции: <?= date('d M Y', strtotime($date_bank['order_date'])) ?></p>
      <p>Способ оплаты: Банк <?= $date_bank["payment_method_bank"] ?></p>
    </div>
    <div class="admin__card">
      <table>
        <thead>
        ...
        <tbody>
          <?php foreach ($order_info as $i => $ord) : ?>
            <tr>
              ...
              <td>₽<?= number_format($ord["plant_price"]) ?></td>
