...
<div class="admin">
  <div class="admin__header">
    ...
    <h1 class="admin__title">Детали товара</h1>
  </div>
  <div class="admin__body">
    <div class="admin__card">
      <form action="./product-single.php?plant_id=<?= $plant['plant_id'] ?>" method="post" class="page-single" enctype="multipart/form-data">
        ...
        <div>
          <label for="price" class="input-label">Цена <span class="text-danger">*</span></label>
        ...
        <div>
          <label for="category_id" class="input-label">Категория <span class="text-danger">*</span></label>
        ...
        <div>
          <label for="supplier_id" class="input-label">Поставщик <span class="text-danger">*</span></label>
        ...
        <div>
          <label for="stock" class="input-label">На складе осталось <span class="text-danger">*</span></label>
        ...
        <div>
          <label for="photo" class="input-label">Фото</label>
        ...
        <div class="page-single__actions-container">
          <a href="./product-delete.php?plant_id=<?= $plant['plant_id'] ?>" class="page-single__button">Удалить</a>
          <div class="page-single__actions">
            <a href="./products.php" class="page-single__button">Отмена</a>
