    ...
    <div class="profile__body">
      <form action='./editprofile.php' method='POST' class="profile__right">
        <div class="profile__form">
          <div>
            <!-- INPUT NAMA  -->
            <label class="input-label" for='nama'>Имя <span class="text-danger">*</span></label>
          ...
          <div>
            <!-- INPUT NO TELP -->
            <label class="input-label" for='telephone'>Телефон <span class="text-danger">*</span></label>
          ...
          <div>
            <!-- TOMBOL UBAH -->
            <button type="submit" name="ubah" class="profile__button">Сохранить</button>
          </div>
        </div>
      </form>
    </div>
